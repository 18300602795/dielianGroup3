package com.etsdk.app.huov7.chat.cache;
...
//        }
    ...
    public static boolean save(String userId, String nickName, String avatarUrl){
        try {
            ...
            Log.i("333", "userId：" + userId);
            Log.i("333", "avatarUrl：" + avatarUrl);
            Log.i("333", "nickName：" + nickName);
            user.setUserId(userId);
            user.setAvatarUrl(avatarUrl);
            user.setNickName(nickName);
            user.setExpiredDate(new Date().getTime());// 一天过期，单位：毫秒
    ...
    public static void setMsgExt(EMMessage msg){
        ...
        Log.i("333", "kChatUserId：" + user.getUserId());
        Log.i("333", "kChatUserNick：" + user.getNickName());
        Log.i("333", "kChatUserPic：" + user.getAvatarUrl());
    }
