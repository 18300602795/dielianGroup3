package com.etsdk.app.huov7.chat.db;
...
import com.etsdk.app.huov7.chat.Constant;
...
public class DemoDBManager {
    ...
    private DemoDBManager(){
        dbHelper = DbOpenHelper.getInstance(AileApplication.getInstance().getApplicationContext());
    }
